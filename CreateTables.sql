...
CREATE TABLE WineDB.Cliente (
	...
	PRIMARY KEY (NIF),
	FOREIGN KEY (NIF) REFERENCES WineDB.Pessoa(NIF) ON UPDATE CASCADE
);
GO
...
CREATE TABLE WineDB.OperadorAdega (
	...
	PRIMARY KEY (NIF),
	FOREIGN KEY (NIF) REFERENCES WineDB.Funcionario(NIF),
...
CREATE TABLE WineDB.TipoCuba (
	...
	FOREIGN KEY (ID) REFERENCES WineDB.Cuba(ID) ON UPDATE CASCADE
);
GO
...
CREATE TABLE WineDB.OperadorAgricola(
	NIF				INT				NOT NULL,
	Num_Func		INT				NOT NULL,
	ID_Terreno		VARCHAR(5)		NOT NULL, 

	PRIMARY KEY (NIF),
	FOREIGN KEY (NIF) REFERENCES WineDB.Funcionario(NIF) ON UPDATE CASCADE,
	FOREIGN KEY (ID_Terreno) REFERENCES WineDB.Terreno(ID) ON UPDATE CASCADE,
);
GO
